...
Algunas enfermedades como la Esclerosis múltiple, el Linfedema o la Fibromalgia afectan el flujo adecuado de la linfa, generando fatiga muscular, hinchazón, dolor e incomodidad. Por esta razón se utiliza el drenaje linfático manual, un tratamiento que ayuda a mejorar la circulación y reducir la inflamación. Sin embargo este procedimiento tiene ciertas limitaciones: 
1. Dependencia Técnica: la efectividad del masaje depende de profesionales por lo que el paciente no puede realizar tratamientos frecuentes o efectivos desde el hogar. 

2. Falta de Retroalimentación: en la práctica doméstica no es posible medir la presión ejercida en el tejido. una presión excesiva puede obstruir los capilares linfáticos superficiales o una presión insuficiente no tiene resultados en el tratamiento por lo que es limitado a la subjetividad y propenso al error. 

3. Accesibilidad: recurrir con frecuencia a servicios especializados es una carga económica que limita los resultados en los pacientes y por ende sus beneficios a largo plazo
